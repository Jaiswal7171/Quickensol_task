    ...
    <div class="main-content login-panel">
        <div class="login-body">
            <div class="bottom">
                ...
                <form action="../include.php" method="POST" onsubmit="return validateForm()">
                    ...
                    <div class="input-group mb-25">
                        ...
                        <input type="tel" class="form-control" name="phone" placeholder="Phone Number" 
                               pattern="[789][0-9]{9}" 
                               title="Phone number must start with 7, 8, 9, or 0 and be exactly 10 digits long." 
                               required>
                    </div>
               ...
               <div class="input-group mb-20">
                    ...
                    <input type="password" class="form-control rounded-end" name="password" placeholder="Password"
                        pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d).{4,}"
                    ...
                    <button class="btn btn-primary w-100 login-btn" name="register_admin">Sign up</button>
                </form>
